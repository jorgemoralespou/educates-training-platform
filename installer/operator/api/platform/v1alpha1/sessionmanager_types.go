...
type SessionManagerSpec struct {
	...
	// foo is an example field of SessionManager. Edit sessionmanager_types.go to remove/update
	// +optional
...
type SessionManagerStatus struct {
	...
	// conditions represent the current state of the SessionManager resource.
...
// SessionManager is the Schema for the sessionmanagers API
type SessionManager struct {
	...
	// spec defines the desired state of SessionManager
	// +required
	Spec SessionManagerSpec `json:"spec"`

	// status defines the observed state of SessionManager
	// +optional
