...
var _ = BeforeSuite(func() {
	...
	// Platform reconcilers read EducatesClusterConfig.status as their
	// input contract; the CRD has to be registered + installed in
	// envtest for specs to create the gating resource.
